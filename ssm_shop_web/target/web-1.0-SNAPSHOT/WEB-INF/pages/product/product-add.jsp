...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/Product/save" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 data">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="departureTime" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask>
                                </div>
...
<%--                                </div>--%>
                            ...
                            <div class="col-4 data ">
                                <textarea class="form-control" rows="3" name="productDesc" placeholder="其他信息">
                            </textarea>
                            </div>
                        </div>
                    </div>
